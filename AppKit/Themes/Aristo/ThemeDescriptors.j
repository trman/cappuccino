...
+ (CPButton)button
{
    ...
    themedButtonValues =
        [
            ...
            [@"bezel-rounded-color",    roundedBezelColor,                      CPThemeStateBordered],
            [@"bezel-rounded-color",    roundedHighlightedBezelColor,           CPThemeStateBordered | CPThemeStateHighlighted],
            [@"bezel-rounded-color",    roundedDisabledBezelColor,              CPThemeStateBordered | CPThemeStateDisabled],
            [@"bezel-rounded-color",    defaultRoundedBezelColor,               CPThemeStateBordered | CPThemeStateDefault],
            [@"bezel-rounded-color",    defaultRoundedHighlightedBezelColor,    CPThemeStateBordered | CPThemeStateHighlighted | CPThemeStateDefault],
            [@"bezel-rounded-color",    defaultRoundedDisabledBezelColor,       CPThemeStateBordered | CPThemeStateDefault | CPThemeStateDisabled],
            [@"content-inset-rounded",  CGInsetMake(0.0, 10.0, 0.0, 10.0), CPThemeStateBordered],
